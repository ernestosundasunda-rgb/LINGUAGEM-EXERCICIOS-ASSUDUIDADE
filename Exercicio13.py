#Problema: Dada uma lista de dicionários representando pessoas com nome e idade, ordene a
#lista primeiro por idade (crescente) e, em caso de idades iguais, por nome (alfabética).
